...
<div id="wrapper">
  ...
  <div id="form">
    <form action="sign_up_comp.php" method="post" id="edit">
      <div class="formwrapper">
        ...
        <p>Email</p>
        <p class="red err<?php echo $err;?>">※このemailは既に使用されています。</p>
      ...
      <div class="popup">
        ...
        <div class="inlineB"><input type="submit" value="登録する" class="btn"></div>
